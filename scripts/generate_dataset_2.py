...
for name, gen in [('normal', pb.random_normal), ('uniform', pb.random_uniform), ('exponential', pb.random_exponential), ('uniform_on_hypersphere', pb.uniform_on_hypersphere)]:
    while True:
